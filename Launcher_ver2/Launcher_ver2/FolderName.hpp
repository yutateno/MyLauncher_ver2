...
private:
	...
	// ランチャーのためのゲームのメディア類の名前をそれぞれ調べる
	std::string SearchMediaFile(std::string gamePath, std::string gamefilename, std::string extension);				

	// ランチャー.exeと同じ階層に入れたゲームのフォルダ名を調べる
